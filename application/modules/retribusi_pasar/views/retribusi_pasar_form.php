...
<form id="frm" method="post" action="<?php echo base_url(); ?>retribusi_pasar/<?php echo $link_proses;?>">
  <fieldset>
  ...
  <fieldset>
    ...
    <div class="controls-row">
      <div class="control-group">
        <label class="control-label" for="jumlah">Jumlah Pajak</label>
        <input type="text" class="span2 currency" id="jumlah" readonly="1" data-bind="numeralvalue: jumlah" />
      </div>
    </div>
    <div class="controls-row">
...
$(document).ready(function() {
  ...
  var ModelRetribusiPasar = function (){
    var self = this;
    ...
    self.jumlah = ko.observable('<?php echo isset($data['JUMLAH_PAJAK']) ? $data['JUMLAH_PAJAK'] : 0 ?>');
  ...
  var App = new ModelRetribusiPasar();
  ...
  App.pilih_rekening = function(){
    ...
    var option = {multi:0, mode:'retribusi_pasar'};
