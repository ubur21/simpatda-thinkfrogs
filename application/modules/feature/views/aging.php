	...
	$(document).ready(function() {
		...
		$("#grid").jqGrid({
			...
			datatype:'json',
			mtype:'POST',
			colNames:['JABATAN','NAMA','NIP','GOLONGAN','PANGKAT','STATUS'],
			colModel:[
				{name:'jabatan',index:'jabatan',width:180,editable:true,editoptions:{size:30,class:'autocomplete span3'},editrules:{required:true}},
				{name:'nama',index:'nama',width:180,editable:true,editoptions:{size:30,class:"span3"},editrules:{required:true}},
				{name:'nip', index:'nip',width:115,editable:true,edittype:'text',editoptions:{size:10,class:"span2"}},
				{name:'golongan', index:'golongan',width:65,editable:true,edittype:'text',editoptions:{size:10,class:"span1"}},
				{name:'pangkat', index:'pangkat',width:115,editable:true,edittype:'text',editoptions:{size:10,class:"span2"}},
