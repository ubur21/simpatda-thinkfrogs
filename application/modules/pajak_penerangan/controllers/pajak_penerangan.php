...
class Pajak_penerangan extends Base_Controller {

  public function __construct()
  {
    parent::__construct();
    $this->load->model('pajak_penerangan_model', 'data_model');
  }
  ...
  {
    $data['breadcrumbs'] = 'Daftar Pajak Penerangan (Self Assessment)';
    $data['title'] = PRODUCT.' - '.$data['breadcrumbs'];
    $data['modul'] = 'pajak_penerangan';
    $data['link_daftar'] = '/get_daftar_sa';
    $data['link_form'] = '/form_sa';
    $data['main_content'] = 'pajak_penerangan_view';
    $data['tipe'] = 'sa';
  ...
  {
    $data['breadcrumbs'] = 'Daftar Pajak Penerangan (Official Assessment)';
    $data['title'] = PRODUCT.' - '.$data['breadcrumbs'];
    $data['modul'] = 'pajak_penerangan';
  ...
  function get_tarif_penerangan($jumlah)
  {
    switch($jumlah)
    {
    ...
    $result = $this->data_model->get_tarif_penerangan_by_kode($kode);
    if (count($result) > 0)
    {
  ...
  {
    $data['title'] = $this->app['app_name']. ' - Pajak Penerangan (Official Assessment)';
    $data['modul'] = 'pajak_penerangan';
    $data['tipe'] = 'OA';
    $data['link_proses'] = 'proses';
    $data['link_back'] = '/daftar_oa';
    $data['form'] = '/form_oa';
    $data['header'] = 'Pajak Penerangan (Official Assessment)';
    ...
    $data['main_content']='pajak_penerangan_form';
    $this->load->view('layout/template',$data);
  }
  
  public function form_sa($id=0)
  {
    $data['title'] = $this->app['app_name'] . ' - Pajak Penerangan (Self Assessment)';
    $data['modul'] = 'pajak_penerangan';
    $data['tipe'] = 'SA';
    $data['link_proses'] = 'proses';
    $data['link_back'] = '/daftar_sa';
    $data['form'] = '/form_sa';
    $data['header'] = 'Pajak Penerangan (Self Assessment)';
    $data['akses'] = $this->access;
    if ($id!==0)
    {
      $data['data'] = $this->data_model->get_data_by_id($id);
  ...
  public function proses()
  {
    ...
    if ($this->form_validation->run() == TRUE){
      ...
      $tarif_penerangan = $this->input->post('tarif_penerangan');
      ...
      else if($tarif_penerangan === '0')
      {
        $response->isSuccess = FALSE;
        $response->message = 'Tarif Penerangan untuk jumlah tersebut belum ada';
      }
      else
      {
        ...
        if (!$success)
        {
          ...
          $response->sql = $this->db->queries;
          $response->tarif_penerangan = $tarif_penerangan;
        }
        else
        {
          $response->isSuccess = FALSE;
  ...
  public function hapus()
  {
    ...
    if ($result) {
      ...
      $response->isSuccess = TRUE;
      $response->message = 'Data Pajak Penerangan telah dihapus.';
    }
    else{
