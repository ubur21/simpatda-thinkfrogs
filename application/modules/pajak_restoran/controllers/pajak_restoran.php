...
class Pajak_restoran extends Base_Controller {

  public function __construct()
  {
    parent::__construct();
    $this->load->model('pajak_restoran_model', 'data_model');
  }
  ...
  {
    $data['breadcrumbs'] = 'Daftar Pajak Restauran (Official Assessment)';
    $data['title'] = PRODUCT.' - '.$data['breadcrumbs'];
    $data['modul'] = 'pajak_restoran';
    $data['link_daftar'] = '/get_daftar_oa';
    $data['link_form'] = '/form_oa';
    $data['main_content'] = 'pajak_restoran_view';
    $data['tipe'] = 'oa';
  ...
  {
    $data['breadcrumbs'] = 'Daftar Pajak Restauran (Self Assessment)';
    $data['title'] = PRODUCT.' - '.$data['breadcrumbs'];
    $data['modul'] = 'pajak_restoran';
  ...
  function get_tarif_restoran($jumlah)
  {
    switch($jumlah)
    {
    ...
    $result = $this->data_model->get_tarif_restoran_by_kode($kode);
    if (count($result) > 0)
    {
  ...
  public function form_sa($id=0)
  {
    ...
    $data['form'] = '/form_sa';
    $data['header'] = 'Pajak Restauran (Self Assessment)';
    ...
    $data['main_content']='pajak_restoran_form';
    $this->load->view('layout/template',$data);
  }
  ...
  public function form_oa($id=0)
  {
    ...
    $data['form'] = '/form_oa';
    $data['header'] = 'Pajak Restauran (Official Assessment)';
    $data['akses'] = $this->access;
    if ($id!==0)
    {
      $data['data'] = $this->data_model->get_data_by_id($id);
  ...
  public function hapus()
  {
    ...
    if ($result) {
      ...
      $response->isSuccess = TRUE;
      $response->message = 'Data Pajak Restauran (Official Assessment) telah dihapus.';
    }
    else{
