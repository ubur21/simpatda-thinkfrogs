=============================================== reminder
SELECT a.ID_BLN, a.DESK_BLN , b.npwpd,b.NAMA_WP,coalesce((select max(jumlah_pajak) from spt where npwpd = b.npwpd group by npwpd),0) as jml_pajak
FROM MST_BULAN a
...
where a.id <= 1 and c.tanggal_spt is null

============================================= aging 

SELECT XX.* ,YY.PERIODE_AWAL AS TGL_TERBIT,COALESCE(YY.JUMLAH_PAJAK,0) JUMLAH_PAJAK
...
)XX INNER JOIN SPT YY ON XX.ID_SPT = YY.ID_SPT
ORDER BY XX.TIPE DESC