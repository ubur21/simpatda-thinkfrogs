...
class anggaranstatus extends Controller
{	
	var $error_msg;
	
	function anggaranstatus()
	{
		parent::Controller();
		$this->error_msg='';
		$this->load->library('firephp');
		$this->load->model('anggaranstatus_model','data_model');
	}
	
	function index()
	{		
		if(b_logged()){
			$data['main_content'] = $this->load->view('master/daftar_anggaranstatus','',true);
		}else{
