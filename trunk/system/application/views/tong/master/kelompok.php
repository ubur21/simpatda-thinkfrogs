...
<script type="text/javascript">
	jQuery("#grid").jqGrid(
	{ 
		url:'<?php echo site_url('master/kelompok/get_daftar')?>', 
		editurl:'<?php echo site_url('master/kelompok')?>', 
		mtype: "post",
		datatype: "json", 
		colNames:['ID', 'Induk', 'Golongan', 'Bidang', 'Kelompok', 'Sub', 'SubSub', 'Kode', 'Uraian', 'Satuan', 'Jenis Aset'], 
		colModel:[ 
			{
				name:'id',
				index:'id_kelompok', 
			...
			}, 
			{
				...
				edittype:'select', 
				editoptions: {
					dataUrl:'<?php echo site_url('master/kelompok/getselect')?>', 
					style:'width:200px;'
				}
			},
			{
