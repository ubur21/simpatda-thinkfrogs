<table id="grid_gaji"></table>
<div id="pager_gaji"></div>	

<script type="text/javascript">
jQuery("#grid_gaji").jqGrid({ 
	url:'<?php echo site_url('pegawai/get_gaji').'/'.$id?>', 
	editurl:'<?php echo site_url('pegawai/gaji')?>', 
	datatype: "json", 
	mtype: 'POST',
