...
jQuery(document).ready(function(){ 
	jQuery("#htmlTable").jqGrid({
		url:'<?php echo site_url('master/kategori_rekening/daftar')?>', 
		editurl:'<?php echo site_url('master/kategori_rekening/daftar')?>', 
		datatype: 'json',
		mtype: 'POST',
		colNames:['id', 'Kode', 'Nama','Saldo Normal' ],
		colModel :[{
			 name:'id'
			,index:'id'
			,search:false
		...
		width: 800,
		height: 230,
		caption:"Daftar Kategori Rekening",
