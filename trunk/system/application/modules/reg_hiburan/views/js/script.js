...
jQuery(document).ready(function(){
	...
	jQuery("#npwprdTable").jqGrid({
		url: root+'/pendaftaran/seeknpw/PAJAK/03',
		datatype: 'json',
		mtype: 'POST',
...
jQuery(document).ready(function(){
	...
	jQuery("#dataTable").jqGrid({
		...
		datatype: 'json',
		mtype: 'POST',
		colNames:['id','Kode Rekening','Dasar Pengenaan','Persen Tarif','Pajak'],//,'Jumlah','Dasar Tarif'
		colModel :[
			{name:'id',index:'id',width:20,search:false},
...
jQuery(document).ready(function(){ 
	...
	jQuery('#trigger_npw').click(function(){
		...
		jQuery("#npwprdTable").setGridParam({url:root+'/pendaftaran/seeknpw/'+x+'/03', datatype:'json'}).trigger("reloadGrid");
