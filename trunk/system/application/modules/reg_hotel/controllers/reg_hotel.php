...
class reg_hotel extends Controller
{	
	var $error_msg;
	var $result_msg;
	...
	function reg_hotel()
	{
		...
		$this->load->model('reg_hotel_model','data_model');
	...
	{		
		...
		$arr['hotel_nama']  = $this->input->post('nama_hotel');
		$arr['hotel_alamat']  = $this->input->post('alamat_hotel');
