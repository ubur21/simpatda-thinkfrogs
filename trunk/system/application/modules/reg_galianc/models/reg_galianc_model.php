...
class reg_galianc_model extends Model {
	...
	function reg_galianc_model()
	{
		parent::Model();
		$this->_table    = 'pendataan_spt';
		$this->_table_pk = 'pendataan_id';	
		
		$this->_table_rincian    = 'pendataan_galianc';
		$this->_table_rincian_pk = 'galianc_id';
