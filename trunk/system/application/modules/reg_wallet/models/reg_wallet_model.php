...
class reg_wallet_model extends Model {
	...
	function reg_wallet_model()
	{
		parent::Model();
		$this->_table    = 'pendataan_spt';
		$this->_table_pk = 'pendataan_id';	
		
		$this->_table_rincian    = 'pendataan_pwalet';
		$this->_table_rincian_pk = 'pwalet_id';
