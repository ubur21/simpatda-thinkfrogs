...
class penetapan_pr_model extends Model {
	...
	function penetapan_pr_model()
	{
		parent::Model();
		$this->_table    = 'penetapan_pr';
		$this->_table_pk = 'penetapan_pr';	
		
		$this->_table_rincian    = 'penetapan_pr_content';
		$this->_table_rincian_pk = 'penetapan_pr_content_id';
		
		$this->_table_detail     = 'penetapan_pr_detail';
		$this->_table_detail_pk  = 'penetapan_pr_detail_id';		
	...
	function setID()
	{
		$result = $this->db->query('select gen_id(GEN_PENETAPAN_PR,1) as maks from RDB$DATABASE');
	...
	function get_data($arr)
	{
		...
		$this->db->select('a.PENETAPAN_PR_ID, a.NO_PENETAPAN, a.TGL_PENETAPAN, a.TGL_SETOR, a.NOMINAL_PENETAPAN,c.pendataan_no,c.tgl_entry');
