...
class reg_listrik_model extends Model {
	...
	function reg_listrik_model()
	{
		parent::Model();
		$this->_table    = 'pendataan_spt';
		$this->_table_pk = 'pendataan_id';	
		
		$this->_table_rincian    = 'pendataan_listrik';
		$this->_table_rincian_pk = 'retribusi_id';
	...
	function fill_rincian_data($arr=array())
	{
		if($arr['ID']=='')
		{
			...
			$this->data_rincian = array(
				'kode_rekening'=>$arr['kode_rekening']
				,'id_rekening'=>$arr['idrekening']
				,'kva'=>$arr['kva']
				,'diskon'=>$arr['diskon']
				,'jam'=>$arr['jam']
