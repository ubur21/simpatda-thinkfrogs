...
<fieldset class='fieldset' style='width:900px'>
	...
	<div class='fd_right'>
		<div><label>Retribusi :</label><input type='text' name='total' id='total' class='currency total' value='0.00' readonly ></div>
		<div><label>Jumlah <span class='wajib'>*</span> :</label><input type='text' name='jumlah' id='jumlah' class="currency {required:true,messages:{required:'Jumlah belum diisi'}}"></div>
		<div><label>Tarif Dasar :</label><input type='text' name='dasar_tarif' id='dasar_tarif' class='currency' readonly></div>
		<div><label>Dasar Pengenaan :</label><input type='text' name='dasar_pengenaan' id='dasar_pengenaan' class='currency' readonly></div>		
	</div>
</fieldset>
