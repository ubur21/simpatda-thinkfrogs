...
class posanggaran extends Controller
{	
	var $error_msg;
	
	function posanggaran()
	{
		parent::Controller();
		$this->error_msg='';
		$this->load->library('firephp');
		$this->load->model('posanggaran_model','data_model');
	}
	
	function index()
	{		
		if(b_logged()){
			$data['main_content'] = $this->load->view('master/daftar_posanggaran','',true);
		}else{
