...
<fieldset class='fieldset' style='width:900px'>
	...
	<div class='fd_right'>
		...
		<div><label>Pemakaian (Kva)  <b class="wajib">*</b> :</label><input type="text" name="kva" title='Pemakaian (Kva)' id="kva" style='text-align:right'/></div>
		<div><label>Jam <b class="wajib">*</b> :</label><input type="text" name="jam" title='Jam' id="jam" style='text-align:right'/></div>
		<div><label>Tarif Dasar <b class="wajib">*</b> :</label><input type="text" name="dasar_tarif" title='Tarif Dasar' id="dasar_tarif" style='text-align:right'/></div>							
		<div><label>Faktor Diskon <b class="wajib">*</b> :</label><input type="text" name="diskon" title='Faktor Diskon' id="diskon"  style='text-align:right'/></div>
		<div><label>Dasar Pengenaan :</label><input type="text" name="dasar_pengenaan" title='Dasar Pengenaan' id="dasar_pengenaan" style='text-align:right' readonly /></div>
