...
<fieldset class='fieldset' style='width:900px'>
	<div class='fd_left'>
		...
		<div><label>Nama Hotel :</label><input type='text' name='nama_hotel' id='nama_hotel' ></div>
		<div><label>Alamat Hotel :</label><textarea cols='35' name='alamat_hotel' id='alamat_hotel'></textarea></div>
	</div>
	<div class='fd_right'>
