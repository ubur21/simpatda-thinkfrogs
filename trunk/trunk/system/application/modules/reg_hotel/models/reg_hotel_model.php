...
class reg_hotel_model extends Model {
	...
	function reg_hotel_model()
	{
		parent::Model();
		$this->_table    = 'pendataan_spt';
		$this->_table_pk = 'pendataan_id';	
		
		$this->_table_rincian    = 'pendataan_hotel';
		$this->_table_rincian_pk = 'hotel_id';
	...
	function fill_rincian_data($arr=array())
	{
		if($arr['ID']=='')
		{
			...
			$this->data_rincian = array(
				...
				,'nominal'=>$arr['nominal']
				,'hotel_nama'=>$arr['hotel_nama']
				,'hotel_alamat'=>$arr['hotel_alamat']
