...
class reg_retribusi extends Controller
{	
	var $error_msg;
	var $result_msg;
	
	function reg_retribusi()
	{
		parent::Controller();
		$this->error_msg=''; $this->result_msg='';
		//$this->load->library('firephp');
		//$this->load->library('jqgridcss','','css');
		$this->load->model('reg_retribusi_model','data_model');
	...
	{		
		...
		$arr['jumlah']		   = str_replace(',','',$this->input->post('jumlah'));
		$arr['nominal']		   = str_replace(',','',$this->input->post('dasar_pengenaan'));
