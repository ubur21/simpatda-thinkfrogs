...
class reg_airtanah_model extends Model {
	...
	function reg_airtanah_model()
	{
		parent::Model();
		$this->_table    = 'pendataan_spt';
		$this->_table_pk = 'pendataan_id';	
		
		$this->_table_rincian    = 'pendataan_air';
		$this->_table_rincian_pk = 'air_id';
	...
	function get_rekening($arr='')
	{
		...
		$this->db->where("lower(a.nama_rekening) like '%air%tanah%' ");
