...
class reg_restoran_model extends Model {
	...
	function reg_restoran_model()
	{
		parent::Model();
		$this->_table    = 'pendataan_spt';
		$this->_table_pk = 'pendataan_id';	
		
		$this->_table_rincian    = 'pendataan_restoran';
		$this->_table_rincian_pk = 'restoran_id';
	...
	function fill_rincian_data($arr=array())
	{
		if($arr['ID']=='')
		{
			...
			$this->data_rincian = array(
				...
				,'nominal'=>$arr['nominal']
				,'restoran_nama'=>$arr['restoran_nama']
				,'restoran_alamat'=>$arr['restoran_alamat']
				,'restoran_id_desa'=>$arr['restoran_id_desa']
			);
