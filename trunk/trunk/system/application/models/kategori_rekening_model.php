<?php
class kategori_rekening_model extends Model {

	var $data;
	var $select;

	function kategori_rekening_model()
	{
		parent::Model();
		$this->_table = 'rekening_kategori';
		$this->_pk = 'id';	
	...
	{
		$this->data = array(
			'tipe_kategori'=>$this->input->post('kode'),
			'nama_kategori'=>$this->input->post('nama'),
			'saldo_normal'=>$this->input->post('saldo')
		);
	}
