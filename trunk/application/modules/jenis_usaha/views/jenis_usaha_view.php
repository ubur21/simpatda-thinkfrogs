  <fieldset>
    <legend>Daftar Jenis Usaha</legend>
      <select name="field" id="field" class="span2">
		<option value='nama'>Jenis Usaha</option>
...
$(document).ready(function() {
  $("#grid").jqGrid({
    ...
    datatype:'json',
    mtype:'POST',
    colNames:['Kode', 'Jenis Usaha'],
    colModel:[
        {name:'kode', index:'kode', width:150, editable:true, edittype:'text', editoptions:{size:5,class:'span2'}, editrules:{required:true}},
        {name:'nama', index:'nama', width:550, editable:true, edittype:'text', editoptions:{size:100,class:'span7'}, editrules:{required:true}}
    ],
    rowNum:-1,
    scroll:true,
    rownumbers:true,
