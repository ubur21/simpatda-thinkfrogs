...
class Retribusi_pasar extends Base_Controller {

  public function __construct()
  {
    parent::__construct();
    $this->load->model('retribusi_pasar_model', 'data_model');
  }
  ...
  {
    $data['breadcrumbs'] = 'Daftar Retribusi Pasar (Self Assessment)';
    $data['title'] = PRODUCT.' - '.$data['breadcrumbs'];
    $data['modul'] = 'retribusi_pasar';
    $data['link_daftar'] = '/get_daftar_sa';
    $data['link_form'] = '/form_sa';
    $data['main_content'] = 'retribusi_pasar_view';
    $data['tipe'] = 'sa';
  ...
  {
    $data['breadcrumbs'] = 'Daftar Retribusi Pasar (Official Assessment)';
    $data['title'] = PRODUCT.' - '.$data['breadcrumbs'];
    $data['modul'] = 'retribusi_pasar';
  ...
  {
    $data['title'] = $this->app['app_name']. ' - Retribusi Pasar (Official Assessment)';
    $data['modul'] = 'retribusi_pasar';
    $data['tipe'] = 'OA';
    $data['link_proses'] = 'proses';
    $data['link_back'] = '/daftar_oa';
    $data['form'] = '/form_oa';
    $data['header'] = 'Retribusi Pasar (Official Assessment)';
    ...
    $data['main_content']='retribusi_pasar_form';
    $this->load->view('layout/template',$data);
  }
  
  public function form_sa($id=0)
  {
    $data['title'] = $this->app['app_name'] . ' - Retribusi Pasar (Self Assessment)';
    $data['modul'] = 'retribusi_pasar';
    $data['tipe'] = 'SA';
    $data['link_proses'] = 'proses';
    $data['link_back'] = '/daftar_sa';
    $data['form'] = '/form_sa';
    $data['header'] = 'Retribusi Pasar (Self Assessment)';
    $data['akses'] = $this->access;
    if ($id!==0)
    {
      $data['data'] = $this->data_model->get_data_by_id($id);
  ...
  public function hapus()
  {
    ...
    if ($result) {
      ...
      $response->isSuccess = TRUE;
      $response->message = 'Data Retribusi Pasar telah dihapus.';
    }
    else{
