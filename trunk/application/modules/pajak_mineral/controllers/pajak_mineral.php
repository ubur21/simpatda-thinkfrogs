...
class Pajak_mineral extends Base_Controller {

  public function __construct()
  {
    parent::__construct();
    $this->load->model('pajak_mineral_model', 'data_model');
  }
  ...
  {
    $data['breadcrumbs'] = 'Daftar Pajak Mineral non Logam dan Batuan (Official Assessment)';
    $data['title'] = PRODUCT.' - '.$data['breadcrumbs'];
    $data['modul'] = 'pajak_mineral';
    $data['link_daftar'] = '/get_daftar_oa';
    $data['link_form'] = '/form_oa';
    $data['main_content'] = 'pajak_mineral_view';
    $data['tipe'] = 'oa';
  ...
  public function form_sa($id=0)
  {
    ...
    $data['form'] = '/form_sa';
    $data['header'] = 'Pajak Mineral non Logam dan Batuan (Self Assessment)';
    ...
    $data['main_content']='pajak_mineral_form';
    $this->load->view('layout/template',$data);
  }
  ...
  public function form_oa($id=0)
  {
    ...
    $data['form'] = '/form_oa';
    $data['header'] = 'Pajak Mineral non Logam dan Batuan (Official Assessment)';
    $data['akses'] = $this->access;
    if ($id!==0)
    {
      $data['data'] = $this->data_model->get_data_by_id($id);
  ...
  public function hapus()
  {
    ...
    if ($result) {
      ...
      $response->isSuccess = TRUE;
      $response->message = 'Data Pajak Mineral non Logam dan Batuan (Official Assessment) telah dihapus.';
    }
    else{
