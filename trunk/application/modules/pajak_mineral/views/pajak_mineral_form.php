...
<form id="frm" method="post" action="<?php echo base_url(); ?>pajak_mineral/<?php echo $link_proses;?>">
  <fieldset>
  ...
  <fieldset>
    ...
    <div class="controls-row" >
      <div class="control-group pull-left" >
        <label class="control-label" for="jumlah">Jumlah (Ton/m3)</label>
        <input type="text" class="span3 currency" id="jumlah" data-bind="numeralvalue: jumlah" />
      </div>
...
$(document).ready(function() {
  ...
  App.pilih_rekening = function(){
    ...
    var option = {multi:0, mode:'pendataan_mineral'};
