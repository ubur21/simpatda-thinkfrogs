...
class Pajak_air extends Base_Controller {

  public function __construct()
  {
    parent::__construct();
    $this->load->model('pajak_air_model', 'data_model');
  }
  ...
  {
    $data['breadcrumbs'] = 'Daftar Pajak Air Bawah Tanah (Official Assessment)';
    $data['title'] = PRODUCT.' - '.$data['breadcrumbs'];
    $data['modul'] = 'pajak_air';
    $data['link_daftar'] = '/get_daftar_oa';
    $data['link_form'] = '/form_oa';
    $data['main_content'] = 'pajak_air_view';
    $data['tipe'] = 'oa';
  ...
  {
    $data['breadcrumbs'] = 'Daftar Pajak Air Bawah Tanah (Self Assessment)';
    $data['title'] = PRODUCT.' - '.$data['breadcrumbs'];
    $data['modul'] = 'pajak_air';
  ...
  function get_tarif_air($jumlah)
  {
    ...
    $result = $this->data_model->get_tarif_air_by_kode($kode);
    if (count($result) > 0)
    {
  ...
  public function form_oa($id=0)
  {
    ...
    $data['form'] = '/form_oa';
    $data['header'] = 'Pajak Air Bawah Tanah (Official Assessment)';
    ...
    $data['main_content']='pajak_air_form';
    $this->load->view('layout/template',$data);
  }
  ...
  public function form_sa($id=0)
  {
    ...
    $data['form'] = '/form_sa';
    $data['header'] = 'Pajak Air Bawah Tanah (Self Assessment)';
    $data['akses'] = $this->access;
    if ($id!==0)
    {
      $data['data'] = $this->data_model->get_data_by_id($id);
  ...
  public function proses()
  {
    ...
    if ($this->form_validation->run() == TRUE){
      ...
      {
        $response->isSuccess = FALSE;
        $response->message = 'Tarif air untuk jumlah tersebut belum ada';
      }
      else
      {
  ...
  public function hapus()
  {
    ...
    if ($result) {
      ...
      $response->isSuccess = TRUE;
      $response->message = 'Data Pajak Air Bawah Tanah (Official Assessment) telah dihapus.';
    }
    else{
