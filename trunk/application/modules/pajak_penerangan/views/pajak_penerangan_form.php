...
<form id="frm" method="post" action="<?php echo base_url(); ?>pajak_penerangan/<?php echo $link_proses;?>">
  <fieldset>
...
$(document).ready(function() {
  ...
  App.pilih_rekening = function(){
    ...
    var option = {multi:0, mode:'pendataan_peneranganjalan'};
