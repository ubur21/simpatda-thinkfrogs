<?php
class Pajak_penerangan_model extends CI_Model {
  ...
  function get_tarif_penerangan_by_kode($kode)
  {
    $this->db->select('nominal');
    $this->db->from('tarif_penerangan');
  ...
  function get_data($param, $isCount=FALSE, $CompileOnly=False)
  {
    ...
    $this->db->where('a.id_spt not in (select id_spt from detil_reklame)');
