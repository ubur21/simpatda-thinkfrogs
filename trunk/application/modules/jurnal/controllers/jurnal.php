...
class Jurnal extends Base_Controller {
  public function __construct()
  {
    ...
    $this->load->model('jurnal_model','data_model');
    $this->load->library('form_validation');
  }

  public function index()
  {
    $data['title'] = $this->app['app_name'].' - '.' Jurnal';
    $data['main_content'] = 'jurnal_view';
      ...
      if($oper == 'edit') {
        ...
        if($id == 'new') {
          ...
          if ($result == FALSE){
            ...
            $response->message = 'Jurnal telah disimpan.';
            $response->id = $newid;
			//echo "4";exit;
          }
          else
          {
            ...
            $response->message = 'Jurnal tersebut sudah ada.';
			echo "3";exit;
          }
        }
        else {
            ...
            $response->isSuccess = TRUE;
            $response->message = 'Jurnal telah diubah.';
...
*/      // bisa dihapus
      ...
      $response->isSuccess = TRUE;
      $response->message = 'Jurnal daerah telah dihapus';
/*    }
    else
    {
