...
<form id="frm" method="post" action="<?php echo base_url(); ?>pajak_hiburan/<?php echo $link_proses;?>">
  <fieldset>
...
$(document).ready(function() {
  ...
  App.pilih_rekening = function(){
    ...
    var option = {multi:0, mode:'pendataan_hiburan'};
  ...
  App.pilih_npwpd = function(){
    if (!App.canSave() || App.isEdit()) { return; }
    var option = {multi:0, mode:'pendataan_hiburan_npwpd'};
