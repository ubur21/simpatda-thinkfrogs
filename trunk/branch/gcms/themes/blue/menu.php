...
.yui-skin-sam .yuimenubar.hide-submenu-shadow .yui-menu-shadow-visible {
	display: none;
}
</style>
...
<TR>
	...
	<TD HEIGHT=28 bgcolor="#EFEFEF" style="padding-top:9px;">
       ...
       <div id="gcms_main_menu" class="yuimenubar yuimenubarnav" style="z-index:100">
            <div class="bd">
                <ul class="first-of-type">
                    ...
                    <div id="<?= $m[0]?>" class="yuimenu">
                            <div class="bd">
                                <ul>
                                    ...
                                    <? }else { ?>
                                    <li class="yuimenuitem"><a class="yuimenuitemlabel" href="logout.php"  style="font-size:11px; font-family:Arial; font-weight:bold; cursor:pointer">Logout</a></li> 
                                    <? } 
                                     if(b_logged()){
                                                                ...
                                                                <div class="bd">
                                                                    <ul class="first-of-type">
                                                                        ...
                                                                        $csql = "select a.* from ".PREFIX."frontmenus as a
																				...
																				AND a.cparam !='Group'
																				AND b.nstatus = '1') or a.bsecure=0
																				order By a.nurut";
                                                                        $nres_submenu=gcms_query($csql);
                                                                            while ($menu=gcms_fetch_object($nres_submenu)) {
                                                                                ...
                                                                                if( $menu->csubmenu == 1 ){
                                                                                    ...
                                                                                    ?>
                                                                                    <li class="yuimenuitem"><a class="yuimenuitemlabel"  style="padding-Left:0px; padding-bottom:2px;font-size:11px; font-family:Arial; font-weight:bold;; cursor:pointer;" ><img src="<?= THEME_DIR ?>/images/icon/install.png" style="padding-left:5px;padding-right:5px;/*background-color:#B3D4FF*/; vertical-align:bottom;" /><?= $menu->cmenu?></a>
    ...
    { 
      ...
      itemdata: [ 
                 <? if(!b_logged()) { ?>{ text: "Login", url: "." }, <? }
				  ...
				  {text: "Main Menu", url: "." },
				  //{text: "SMS", url: "request.php?mod=sms" },
                  {text: "Help", url: "./docs/SIMATAP.pdf" },
				  {text: "Informasi Perizinan", 
				 	submenu:{
						id:"view",
							itemdata:[ {text:"Cari Status Pemohon", url:"javascript:gcms_open_form('./dashboard/view_status.php','Find',1300,1000)"},
									   {text:"Sedang di Proses", url:"javascript:gcms_open_form('./dashboard/izindiproses.php','Belum',1300,1000)"},
									   {text:"Telah di Proses", url:"javascript:gcms_open_form('./dashboard/izinselesai.php','Telah',1300,1000)"},
									   {text:"Persyaratan Izin", url:"javascript:gcms_open_form('./dashboard/informasi.php','Informasi',1300,1000)"}
							         ]
					}		}
                ] 
    } 
