                                                            ...
                                                            <div id="<?= "sub_perent_menu_".str_replace(" ","_",$m[$i][0]);?>" class="yuimenu">
                                                                <div class="bd">
                                                                    <ul class="first-of-type">
                                                                        <? 
                                                                        //include(".../config.php");
                                                                        $csql = "select a.* from ".PREFIX."frontmenus as a where a.NID_GROUPFRONT_SUBMENUS = ".$m[$i][6]." and bhide = '0' order By a.nurut";
                                                                        $nres_submenu=gcms_query($csql);
                                                                            while ($omenu=gcms_fetch_object($nres_submenu)) {
                                                                                 $nm = str_replace(".", "_", str_replace("-", "_", str_replace(" ", "_", stripslashes($omenu->cmenu))));
                                                                                 if (!$omenu->width) {
                                                                                     $omenu->width = 600;
                                                                                 }else if (!$omenu->height){
                                                                                     $omenu->height = 500;
                                                                                 }else {
                                                                                 }
                                                                                 if ( $omenu->is_main == 1) {
                                                                                    $load_menu = "index.php?page=".$omenu->nid;
                                                                                 }else if ( $omenu->is_main == 2) {
                                                                                    $load_menu = "javascript:gcms_open_form('form_entri.php?page=".$omenu->nid."','".$nm."',".$omenu->width.",".$omenu->height.")";
                                                                                 }else {
                                                                                    $load_menu = "javascript:gcms_open_form('form.php?page=".$omenu->nid."','".$nm."',".$omenu->width.",".$omenu->height.")";
                                                                                 }	
                                                                                if( $omenu->csubmenu == 1 ){
                                                                                    ?>
                                                                                    <li class="yuimenuitem"><a class="yuimenuitemlabel"  style="padding-Left:0px; padding-bottom:2px;font-size:11px; font-family:Arial; font-weight:bold; cursor:pointer;" href="<?= $load_menu ; ?>"><img src="<?= THEME_DIR ?>/images/icon/install.png" style="padding-left:5px;padding-right:5px;/*background-color:#B3D4FF*/; vertical-align:bottom;" /><?= $omenu->cmenu?></a></li>
                                                                                    <?
                                                                                }else if ( $omenu->csubmenu == 2){	
                                                                                    ?>
                                                                                    <li class="yuimenuitem"><a class="yuimenuitemlabel"  style="padding-Left:0px; padding-bottom:2px;font-size:11px; font-family:Arial; font-weight:bold;" ><img src="<?= THEME_DIR ?>/images/icon/install.png" style="padding-left:5px;padding-right:5px;/*background-color:#B3D4FF*/; vertical-align:bottom;" /><?= $omenu->cmenu?></a>
                                                                                        <div id="<?= "sub_granted_menu_".str_replace(" ", "_", $omenu->cmenu)."menu_4" ?>" class="yuimenu">
                                                                                            <div class="bd">
                                                                                                <ul class="first-of-type">
																								 <?
