...
<TABLE WIDTH="1013" BORDER=0 CELLPADDING=0 CELLSPACING=0>
	...
	<TR>
		<TD WIDTH=19 HEIGHT=77 style="background-image:url($dir/images/model1a_04.png)"></TD>
		<TD bgcolor="#EFEFEF" id='header' >$header</TD> <!---->
		<!--<TD bgcolor="#EFEFEF">
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="975" height="77">
  				<param name="movie" value="$dir/images/header.swf" />
				<param name="quality" value="high" />
				<embed src="$dir/images/header.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="975" height="77"></embed>
			</object>
		</TD> -->
		<TD WIDTH=19 HEIGHT=77 style="background-image:url($dir/images/model1a_06.png)">&nbsp;</TD>
	</TR>
	<TR>
...
function page_header() {
  ...
  if (b_logged()){
  	echo '<div id="container-page2" style="background-color:#EFEFEF"> '."\n";
  	include "menu.php";
	echo '</div>'."\n";
  }
...
function page_footer($login=0) {
  ...
  echo
	...
	<TR>
		...
		<TD style="background-image:url('.$dir.'/images/footer_bkgrnd.png)">
			<div id="footer">'."\n";
