...
$().ready(function(){
	...
	jQuery("#htmlTable2").jqGrid(
	{
		 ...
		 datatype: 'json',
		 mtype: 'POST',
		 colNames:['id','Kode Rekening','Lokasi','Jumlah','Tarif Dasar','Dasar Pengenaan','Persentase','Pajak'],
		 colModel :[
			{ name:'id' ,index:'id'	,width:20 ,search:false	},
			...
			{ name:'lokasi',index:'lokasi',width:120,editable:true,edittype:'text',editoptions: {size:50,maxlength:50},editrules:{required:true}},
		...
		{ width:600,reloadAfterSubmit:false,afterSubmit:processEdit}, // edit
		{ width:600,reloadAfterSubmit:false,afterSubmit:processAdd}, // add
	...
	jQuery("#htmlTable3").jqGrid({
		...
		sortorder: 'asc',
		viewrecords: true,
		caption: 'Data Pajak Air Bawah Tanah',
		subGrid: true,
		multiselect:true,
		multiboxonly:true,
		toolbar: [true,"top"],
	...
	jQuery('#coba1').click(function(){
		...
		jQuery("#htmlTable2 > tbody > tr").each(function (){
			...
			tmp[this.id].sender='entri_pajak_air';
	...
	jQuery('#proses').click(function(){	
		objForm = document.getElementById('entri_pajak_air');
...
<div class='demo'>
	...
	<div id="tabs">
		...
		<div id="tabs-1">
			<div style='padding:5px;'>
				<fieldset>
					<legend>Isian SPTPD Pajak Air Bawah Tanah</legend>
					<div>
