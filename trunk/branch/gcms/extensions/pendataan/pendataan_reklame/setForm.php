...
?>
	document.getElementById('rekening').value='<?=$_REQUEST['val']?>';
	document.getElementById('kode_rekening').value='<?=$rs->kode_rekening?>';
	document.getElementById('nama_rekening').value='<?=$rs->nama_rekening?>';
	document.getElementById('tarif_dasar').value='<?=$rs->tarif_dasar?>';
	document.getElementById('persen_tarif').value='<?=$rs->persen_tarif?>';
<?
}
?>