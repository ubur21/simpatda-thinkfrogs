	...
	case $crudConfig['read']:
		...
		if ($postConfig['q'] <> q) {
			...
			$sql = 
			   'SELECT
				  a.spt_id as id,
				  a.jenis_pungutan as pemungutan,
				  a.spt_no,
				  b.npwp as npw_no,
				  c.nama
				FROM
				  spt a
				  INNER JOIN pendaftaran b on a.pendaftaran_id=b.pendaftaran_id
				  INNER JOIN pemohon c on c.pemohon_id=b.id_pemohon
				WHERE b.objek_pdrd=\'PRIBADI\'
				union
				SELECT
				  a.spt_id as id,				
				  a.jenis_pungutan as pemungutan,
				...
				FROM
				  spt a
				  INNER JOIN pendaftaran b on a.pendaftaran_id=b.pendaftaran_id
				  INNER JOIN badan_usaha c on c.id=b.id_pemohon
				WHERE b.objek_pdrd=\'BU\'
				';			
        } 
        else  {
