...
function setSingleRowDetail( id ) {
	$.getJSON('<?=$expath?>SetData.php?parkir=yes&id='+id, function(data) {
		...
		str += "<td>"+select+"</td><td><input title='dasar pengenaan[]' class='field_angka' id='dasar_tarif"+id+"' type='text' name='dtarif[]' value='' onblur=\"hitung_pajak('"+id+"');\" /></td><td><input title='persen tarif[]' class='field_angka' id='persen_tarif"+id+"' type='text' name='ptarif[]' value='...' size='4' /></td><td><input class='field_angka' id='pajak"+id+"' type='text' name='pajak[]' value='' size='10' /></td>";
